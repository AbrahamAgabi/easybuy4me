!(function (e) {
  ...
  new LazyLoad({ elements_selector: ".lazy" }),
    ...
    e(".categories_carousel").owlCarousel({
      ...
      responsive: {
        0: { nav: !1, dots: !1, items: 2 },
        600: { nav: !1, dots: !1, items: 2 },
        768: { nav: !1, dots: !1, items: 4 },
        1025: { nav: !0, dots: !1, items: 4 },
        1340: { nav: !0, dots: !1, items: 5 },
        1460: { nav: !0, dots: !1, items: 5 },
      },
    }),
    ...
    e(window).on("scroll", function () {
      1 < e(this).scrollTop()
        ? e(".element_to_stick").addClass("sticky")
        : e(".element_to_stick").removeClass("sticky");
    }),
    e(window).scroll(),
    ...
    e(window).bind("load resize", function () {
      e(window).width() <= 768
        ? e("a.cart_bt").removeAttr("data-bs-toggle", "dropdown")
        : e("a.cart_bt").attr("data-bs-toggle", "dropdown");
    });
  var t = e("footer h3");
  e(window)
    .resize(function () {
      e(window).width() <= 768
        ? t.attr("data-bs-toggle", "collapse")
        : t.removeAttr("data-bs-toggle", "collapse");
    })
    .resize(),
    t.on("click", function () {
    ...
    e('a[href^="#"].btn_scroll').on("click", function (t) {
      ...
      e("html, body")
        .stop()
        .animate({ scrollTop: t.offset().top }, 800, "swing", function () {
    ...
    e(".btn_play").magnificPopup({
      type: "iframe",
      closeMarkup:
        '<button title="%title%" type="button" class="mfp-close" style="font-size:26px; margin-right:-10px;">&#215;</button>',
    }),
    ...
    e(".custom_select select").niceSelect(),
    e(".accordion_2").on("hidden.bs.collapse shown.bs.collapse", function (t) {
      e(t.target)
        .prev(".card-header")
        .find("i.indicator")
